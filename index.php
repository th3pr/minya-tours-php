	...
	<div class="full-height">
		<div class="video-wrapper">
			<video loop autoplay muted poster="img/259633153.jpg" class="bgvid" id="bgvid">
				<source type="video/mp4" src="video/This is Egypt.mp4">
							...
							<div class="text-center">
								<div class="drop-tabs">
									...
									<ul class="nav-tabs tpl-tabs tabs-style-1">
										<li class="active click-tabs"><a href="hotels.html" data-toggle="tab" aria-expanded="false">Hotels</a>
										</li>
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide" data-val="0">
								<div class="offers-block radius-mask">
									<div class="clip">
										<div class="bg bg-bg-chrome act" style="background-image:url(img/266598299.jpg)">
										</div>
									</div>
									<div class="tour-layer delay-1"></div>
