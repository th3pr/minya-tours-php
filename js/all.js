...
function validateFormTour() {
    // Retrieving the values of form elements 
     ...
     var mobile = document.information.mobile.value;
	// Defining error variables with a default value
    var fnameErr = lnameErr = emailErr = mobileErr   = true;
    // Validate first name
    if(fname == "") {
    ...
    if((fnameErr || lnameErr || emailErr || mobileErr ) == true) {
       return false;
    } else {
...
// Validate Form in Hotel Details 
