...
if(isset($_GET['car_id1'])){

$ca_id = $_GET['car_id1'];

$sql = "SELECT * FROM `cars` WHERE `car_id`=`$ca_id`";
...
<body data-color="mainColor">
	...
	<div class="inner-banner">
		<img class="center-image" src="img/cars/<?php echo $row['car_image']?>" alt="">
		<div class="vertical-align">
			<div class="container">
				<ul class="banner-breadcrumb color-white clearfix">
					<li><a class="link-blue-2" href="index.php">home</a> /</li>
					<li><a class="link-blue-2" href="cars.php">car</a></li>
				</ul>
							...
							<div class="swiper-container thumbnails-preview" data-autoplay="0" data-loop="1"
								...
								<div class="swiper-wrapper">
									<div class="swiper-slide active" data-val="0">
										<img class="img-responsive img-full" src="img/71BekpCdZvL._UY560_.jpg" alt="">
									</div>
							...
							<div class="simple-tab color-1 tab-wrapper">
								...
								<div class="tabs-content clearfix " style="background-color: white;">
									<div class="tab-info active ">
										...
										<img class="right-img" src="img/71BekpCdZvL._UY560_.jpg" alt="">
					...
					<div class="popular-tours bg-grey-2">
						...
						<div class="hotel-small style-2 clearfix">
							<a class="hotel-img black-hover" href="#">
								<img class="img-responsive radius-0" src="img/2014_Nissan_Versa_01.jpg" alt="">
						...
						<div class="hotel-small style-2 clearfix">
							<a class="hotel-img black-hover" href="#">
								<img class="img-responsive radius-0" src="img/71xbeKJNoyL._UY560_.jpg" alt="">
								<div class="tour-layer delay-1"></div>
							</a>
							<div class="hotel-desc">
								<h5><span class="color-dark-2"><strong>EG 273</strong>/ person</span></h5>
						...
						<div class="hotel-small style-2 clearfix">
							<a class="hotel-img black-hover" href="#">
								<img class="img-responsive radius-0" src="img/front-left-side-47.webp" alt="">
								<div class="tour-layer delay-1"></div>
							</a>
							<div class="hotel-desc">
					...
					<div class="swiper-container hotel-slider" data-autoplay="5000" data-loop="1" data-speed="1000"
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="hotel-item">
									<div class="radius-top">
										<img src="img/71PwiT0x5sL._UY560_.jpg" alt="">
							...
							<div class="swiper-slide">
								<div class="hotel-item">
									<div class="radius-top">
										<img src="img/PORSCHE CAYENNE.jpg" alt="">
										<div class="price price-s-1">EG 973</div>
									</div>
									<div class="title clearfix">
										<h4><b>MARCIDES</b></h4>
