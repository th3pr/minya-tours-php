						...
						<div class="detail-top slider-wth-thumbs style-2">
							<div class="swiper-container thumbnails-preview" data-autoplay="0" data-loop="1"
								...
								<div class="swiper-wrapper">
									<div class="swiper-slide active" data-val="0">
										<img class="img-responsive img-full" src="img/imges/1.jpg" alt="">
									</div>
									<div class="swiper-slide" data-val="1">
										<img class="img-responsive img-full" src="img/imges/10.jpg" alt="">
									</div>
									<div class="swiper-slide" data-val="2">
										<img class="img-responsive img-full" src="img/imges/4.jpg" alt="">
									</div>
									<div class="swiper-slide" data-val="3">
										<img class="img-responsive img-full" src="img/imges/9.jpg">
									</div>
									<div class="swiper-slide" data-val="4">
										<img class="img-responsive img-full" src="img/imges/8.jpg" alt="">
									</div>
								</div>
							...
							<div class="swiper-container thumbnails" data-autoplay="0" data-loop="0" data-speed="500"
								...
								<div class="swiper-wrapper">
									...
									<div class="swiper-slide" data-val="3">
										<img class="img-responsive img-full" src="img/imges/9.jpg" alt="">
									</div>
									<div class="swiper-slide" data-val="4">
										<img class="img-responsive img-full" src="img/imges/8.jpg" alt="">
									</div>
							...
							<div class="simple-tab color-1 tab-wrapper">
								...
								<div class="tabs-content clearfix">
									<div class="tab-info active ">
										...
										<img class="right-img" src="img/tour_list/image/10.jpg" alt="">
