...
<body data-color="mainColor">
	...
	<a href="dashboard.php" class="btn btn-primary" > Dashboard </a>
            ...
            <div class="col-lg-12 col-md-6 col-sm-12 p-3">
                <form action="./PHPFiles/addHotel.php" method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    <label for="inputTour4">Hotel Name</label>
                    <input type="text" name="hotelName" class="form-control" id="inputTour4" placeholder="Hotel Name" required>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="number" name="hotelPrice" class="form-control" id="inputPrice4" placeholder="Hotel Price" required>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <select id="inputGuide" class="form-control" name="hotelType">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" name="hotelAddress" class="form-control" id="inputTour4" placeholder="Hotel Name" required>
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea class="form-control" placeholder="Hotel Details" name="hotelDetails" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                <button type="submit" name="addTour" class="btn btn-primary">Add Hotel</button>
				</div>
              </form>
